...
alive_logo = ALIVE_PIC or "https://te.legra.ph/file/74d210f7ebc9e05437fbc.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/twinkle_starz)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/ab_sumit)\n"
        f"└• **яєρσ**: [Click](https://te.legra.ph/file/be1d79f0f8d48c7e65c43.mp4)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("[REPO](https://te.legra.ph/file/be1d79f0f8d48c7e65c43.mp4)")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("@ab_sumit")
